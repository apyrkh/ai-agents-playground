...
import { askUserNode, inputInterpreterAgent, routeAfterInterpretation } from "../agents/input_interpreter";
...
export function buildGraph() {
  const graph = new StateGraph(GraphState)
    ...
    .addConditionalEdges("input_interpreter", routeAfterInterpretation, {
      ask_user: "ask_user",
